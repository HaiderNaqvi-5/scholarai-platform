...
| `owner` | Governance oversight, role policy control, stage conformance visibility | `frontend/src/app/owner/page.tsx`, `frontend/src/components/auth/owner-route.tsx`, `GET /api/v1/analytics` | `frontend/src/components/owner/owner-dashboard-shell.tsx`, `frontend/src/components/auth/owner-route.tsx` | `Conformant` |  |
