...
- Knowledge Graph Layer: mandatory logical layer, implemented in v0.1 SLC as either narrowly scoped Neo4j or a relationally derived graph abstraction.
...
- Internal v0.1 SLC handoff: `docs/scholarai/INTERNAL_HANDOFF_PACKAGE.md`
...
- Repository status: active internal v0.1 SLC implementation with documentation-led scope control.
...
- Feature work outside v0.1 SLC constraints.
...
- Scope creep into deferred startup features can break v0.1 SLC feasibility.
