<!-- Context: project-intelligence/nav | Priority: high | Version: 1.1 | Updated: 2026-03-23 -->
...
| Topic | File | Notes |
|---|---|---|
| ScholarAI stack and API patterns | `technical-domain.md` | Updated to canonical ScholarAI docs and KPI-gated implementation patterns. |

## 📂 Codebase References

- Canonical project docs: `docs/scholarai/README.md`
- KPI maturity and release gates: `docs/scholarai/KPI_MATURITY_STATUS_20260322.md`
